...
<body>
	<div>
		<ul class="nav">
			...
			<li><a href="/basket"
				style="text-decoration: underline rgb(68, 68, 68);">Basket</a></li>
		</ul>
		...
		<div class="top_section">
			...
			<div class="left_section" style="right: 300px;">
				...
				<div class="pageButton">
					...
					<h1>BasketTotal = £${basket.basketTotalValue}</h1>
					</p>
			...
			<div class="modal hidden">
				...
				<form:form action="/createCheckout" modelAttribute="checkout">
					...
					<form:label path="ccNumber">Full Credit Card Number: </form:label>
					<br>
			...
			<div class="right_section">
				...
				<ul>
					...
					<c:forEach items="${basket.items}" var="bask" varStatus="loop">
						...
						<div class="left_section">
							<img style="width: 206px; height: 230px; object-fit: cover;"
								src="${bask.spice.image}">
						</div>
						...
						<div class="right_section">
							...
							<li class="listItem">
								...
								<div class="box">
									...
									<a href="/spices/${bask.spice.name}">
										<h2>${bask.spice.name}</h2>
									</a>
									<h4>Size: ${bask.size}</h4>
									<h4>Amount: ${bask.quantity}</h4>
									<h4>Price: £${bask.price}</h4>
									<a href="/basket/removeItem/${loop.index}">
										<h3>Remove</h3>
									</a>
				...
				<div class="right_section">
					<a class="pageButton" style="display: block; float: left;"
						href="/emptybasket">
						<h1>Empty Basket</h1>
					</a>
				</div>
